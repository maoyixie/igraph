...
TARGETS="read_edgelist read_dl read_gml read_graphdb read_graphml read_lgl read_ncol read_pajek bliss edge_connectivity vertex_connectivity vertex_separators basic_properties_directed basic_properties_undirected linear_algos_directed linear_algos_undirected centrality community weighted_centrality weighted_community misc_algos igraph_all_minimal_st_separators igraph_read_graph_dl igraph_read_graph_gml igraph_read_graph_graphdb igraph_read_graph_graphml igraph_read_graph_lgl igraph_read_graph_ncol igraph_read_graph_pajek"
